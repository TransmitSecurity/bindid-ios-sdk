#
#  Be sure to run `pod spec lint XmBindIdSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.source       = { :git => "https://github.com/TransmitSecurity/bindid-ios-sdk.git", :tag => "#{spec.version}" }
    ...
    spec.vendored_frameworks = "Sources/XmBindIdSDK.xcframework*"

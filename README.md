...
```ogdl
github "https://github.com/TransmitSecurity/bindid-ios-sdk" ~> 1.15.0
```
...
```swift
dependencies: [
    .package(url: "https://github.com/TransmitSecurity/bindid-ios-sdk.git", .upToNextMajor(from: "1.15.0"))
]
```
